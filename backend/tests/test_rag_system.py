...
class TestRAGSystemQuery:
    ...
    @pytest.fixture
    def rag_system(self, mock_config, mock_vector_store, mock_ai_generator, mock_session_manager):
    ...
    def test_query_retrieves_sources_from_tool(self, rag_system, mock_ai_generator):
        ...
        mock_ai_generator.generate_response.return_value = "Answer based on course content"
    ...
    def test_query_updates_conversation_history(self, rag_system, mock_ai_generator, mock_session_manager):
    ...
    def test_query_with_session_id(self, rag_system, mock_ai_generator, mock_session_manager):
    ...
    def test_query_without_session_id(self, rag_system, mock_ai_generator, mock_session_manager):
    ...
    def test_query_handles_ai_error(self, rag_system, mock_ai_generator):
        ...
        mock_ai_generator.generate_response.side_effect = Exception("AI service unavailable")
...
class TestRAGSystemDocumentProcessing:
    ...
    def test_add_course_document_error(self, rag_system):
        ...
        rag_system.document_processor.process_course_document.side_effect = Exception("Parse error")
...
class TestRAGSystemEndToEnd:
    ...
    def test_full_query_flow_with_tool_use(self, mock_anthropic):
        ...
        second_response.content = [MagicMock(text="MCP stands for Model Context Protocol.")]
